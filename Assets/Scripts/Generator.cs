...
{   
   ...
   public int limit;
    ...
    {
        LaberinthPiece newPiece = Instantiate(laberinthPiece, new Vector3((xMax/2)*5,0,(zMax/2)*5), Quaternion.identity)
            .GetComponent<LaberinthPiece>();
    ...
    {   
        if(map[x, z] == null)
        {
            LaberinthPiece newPiece = Instantiate(laberinthPiece, new Vector3(x * 5, 0, z * 5), Quaternion.identity)
                .GetComponent<LaberinthPiece>();
